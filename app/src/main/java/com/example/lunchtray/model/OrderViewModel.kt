...
class OrderViewModel : ViewModel() {
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        if (menuItems.containsKey(accompaniment)) {
    ...
    fun calculateTaxAndTotal() {
        _tax.value = _subtotal.value!!.toDouble() * taxRate
        _total.value = _subtotal.value!!.toDouble() + _tax.value!!
    }
